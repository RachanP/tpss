...
2. ⚠️ **หัวหน้าวิชาจัดกลุ่มนักศึกษาตั้งแต่แรก — กลับทิศจาก decision 30–31 พ.ค.** ที่ว่า "หัวหน้าวิชาไม่จัดกลุ่ม · subgroup เกิดหลังอนุมัติโดยอาจารย์" (ดู `architecture.md#2-กลุ่มนักศึกษา` + sprint-status). V4 ยืนยันใหม่ว่า **หัวหน้าวิชาจัดทั้งกิจกรรม + กลุ่มย่อยตั้งแต่ตอนกรอกตาราง** โดย **ฐาน = จำนวน นศ. ในชั้นปีของปีนั้น ไม่ใช่ capacity วิชา** → map กลับเป็นตารางเรียนรายกลุ่มได้. ผลกระทบ: **นำหน้าจัดกลุ่มย่อยกลับเข้า course head**, ทบทวน capacity gate, cross-course group conflict ขยับมา *ก่อน* อนุมัติ. ก่อนลงมือต้อง re-confirm กับลูกค้า เพราะขัดกับงานที่ทำไปแล้ว (ถอด group UI ออก)
