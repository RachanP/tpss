...
- 🆕 **Requirement V4 (จากประชุมลูกค้า — `Doc/requirement/requirement_v4.md`)**: 7 ข้อใหม่ **ยังไม่ implement** ดู `.claude/rules/architecture.md#-requirement-v4-update--🔲-proposed-จากประชุมลูกค้า--ยังไม่-implement`. ⚠️ ข้อสำคัญ: **หัวหน้าวิชากลับมาจัดกลุ่มนักศึกษาเองตั้งแต่ขั้นกรอกตาราง** (อิงจำนวน นศ.ชั้นปี ไม่ใช่ capacity) — *กลับทิศ*จาก decision 30–31 พ.ค. ที่ถอด group UI ออก · ต้อง re-confirm ก่อนลงมือ
