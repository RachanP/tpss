<x-app-layout title="ตั้งค่าระบบ">
    <div x-data="{ 
        ...
        <template x-if="showModal && activeTab === 'academic'">
            <div class="overlay" x-cloak @click.self="showModal = false">
                <div class="modal-center" x-transition:enter="transition ease-out duration-300"
                    ...
                    <form
                        :action="editMode ? '{{ url('admin/settings/academic-years') }}/' + currentYear.id : '{{ route('admin.settings.years.store') }}'"
                        method="POST">
                        @csrf
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group" style="margin-top: 16px;">
                                <label
                                    style="display: flex; align-items: center; gap: 8px; cursor: pointer; font-weight: 600; color: var(--fg-1);">
            ...
            <form action="{{ route('admin.settings.constants.update') }}" method="POST">
                ...
                <div style="display: grid; grid-template-columns: 360px 1fr; gap: 24px; align-items: start;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 24px;">
                        ...
                        <div
                            style="padding: 16px; background: var(--status-success-bg); border-radius: 12px; display: flex; gap: 12px;">
                            <div style="color: var(--status-success-fg);"><svg viewBox="0 0 24 24" width="20"
                    ...
                    <div class="card">
                                    ...
                                    @foreach($paCriteria as $rank => $ranges)
                                        <tr>
                                            ...
                                            <td style="padding: 8px;">
                                                <input type="text" name="pa_criteria[{{ $rank }}][t]"
                                                    value="{{ $ranges['t'] }}" class="pa-input">
                                            </td>
                                            <td style="padding: 8px;">
                                                <input type="text" name="pa_criteria[{{ $rank }}][r]"
                                                    value="{{ $ranges['r'] }}" class="pa-input">
                                            </td>
                                            <td style="padding: 8px;">
                                                <input type="text" name="pa_criteria[{{ $rank }}][s]"
                                                    value="{{ $ranges['s'] }}" class="pa-input">
                                            </td>
                                            <td style="padding: 8px;">
                                                <input type="text" name="pa_criteria[{{ $rank }}][c]"
                                                    value="{{ $ranges['c'] }}" class="pa-input">
                                            </td>
                                            <td style="padding: 8px;">
                                                <input type="text" name="pa_criteria[{{ $rank }}][o]"
                                                    value="{{ $ranges['o'] }}" class="pa-input">
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                        ...
                        <div
                            style="padding: 20px; border-top: 1px solid var(--border); background: var(--bg-1); text-align: right;">
