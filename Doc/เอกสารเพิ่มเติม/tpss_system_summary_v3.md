# สรุปขอบเขตระบบ TPSS ตามความเข้าใจของพิม (ฉบับปรับปรุง V3)

เอกสารนี้สรุปจากไฟล์ `รายละเอียดระบบ_V1ล่าสุด.docx` และบริบทที่พิมอธิบายเพิ่มเติม เพื่อใช้เป็นเอกสารทำความเข้าใจขอบเขตของระบบจัดตารางสอนและการฝึกปฏิบัติ (Teaching & Practicum Scheduling System: TPSS)
...
หลักสูตร พย.บ. (ฉบับปรับปรุง พ.ศ. 2565)
  └── วิชา NSBS 301 การพยาบาลผู้ใหญ่ 1 (Course — ข้อมูลถาวร)
        │   หัวหน้าวิชา: อ.สมศรี
        │   หน่วยกิต: 3(2-3-4)
        │   ชั่วโมงบรรยาย: 30 ชม., ชั่วโมงปฏิบัติ: 45 ชม.
        │
        ├── เปิดสอน ปี 2568 เทอม 1 (Course Offering — สร้างใหม่ทุกปี)
        │     ├── กลุ่ม A1 (30 คน), A2 (30 คน), ..., A9 (15 คน)
        │     ├── อ.สมศรี (หัวหน้าวิชา), อ.มานะ, อ.วิชัย, ...
        │     └── ตารางสอน 50+ รายการ
        │
        └── เปิดสอน ปี 2568 เทอม 2 (Course Offering อีกตัว)
              ├── กลุ่ม B1 (30 คน), B2 (30 คน), ..., B9 (15 คน)
              ├── อ.สมศรี (หัวหน้าวิชา), อ.สุดา, อ.ประเสริฐ, ...
              └── ตารางสอน 50+ รายการ
```
...
- **วิชาที่เปิดสอน (Course Offering)**: สร้างขึ้นใหม่ทุกปีการศึกษา/ภาคการศึกษา โดยข้อมูลจะถูก sync จาก Course หลักเข้ามาอัตโนมัติ แล้วจึงเพิ่มกลุ่มนักศึกษา อาจารย์ประจำวิชา และตารางสอนในระดับ Offering นี้

> **ทำไมต้องแยก 2 ชั้น**: ถ้า อ.สมศรี ลาออกจากการเป็นหัวหน้าวิชา → แก้ที่ Course (ข้อมูลถาวร) → มีผลกับทุกปีถัดไป แต่ถ้าเทอมนี้ อ.มานะ มาช่วยสอนแทนชั่วคราว → แก้ที่ Course Offering → มีผลเฉพาะเทอมนี้
...
Template ระดับวิชา (NSBS 301):            Snapshot ระดับ Offering (ปี 2568 เทอม 1):
