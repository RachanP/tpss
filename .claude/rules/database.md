...
student_groups   :  + cohort_group_id FK nullable  ← ชี้ student_cohort ระดับกลุ่มย่อย (parent_id!=null)
                    ที่ B ทำไว้ (อย่าสร้างโครงกลุ่มย่อยใหม่ — ใช้ student_cohorts.parent_id ของ B)
